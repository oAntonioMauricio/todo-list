  ...
  const buildModal = () => {
    ...
    todoForm.addEventListener("submit", (event) => {
      ...
      if (submitForm.innerText === "Submit") {
        ...
        _appLogic_todoLogic__WEBPACK_IMPORTED_MODULE_1__["default"].updateTodo("projects", from, index, {
          title,
          date,
          priority,
        });
